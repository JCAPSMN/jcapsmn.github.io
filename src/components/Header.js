                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div className="navbar-nav ml-auto">
                        ...
                        <span className="d-flex justify-content-around align-items-center">
                            ...
                            <a className="py-0 px-1 fs-1 twitter" href="twitter"><FontAwesomeIcon icon={["fab", "facebook"]} /></a>
                            <a className="py-0 px-1 fs-1 facebook" href="facebook"><FontAwesomeIcon icon={["fab", "twitter"]} /></a>
